<template>
  <v-layout>
    ...
    <v-app-bar color="#16496E" density="compact" elevation="0" class="app-header">
      ...
      <v-btn prepend-icon="mdi-account-cog" variant="text" color="white" @click="handleLogout">
        Admin
      </v-btn>
    </v-app-bar>
...
const menuItems = [
  ...
  { title: 'Postos', icon: 'mdi-gas-station', value: 'station', to: { name: 'UserGasStations' } },
  ...
  { title: 'Central de Ajuda', icon: 'mdi-tooltip-question ', value: 'sobre', to:{ name: 'HelpCenter' } },
]
